const data: Record<TProductId, TProduct> = {
  "2zd33b8c": {
    ...
    sku: "NUR72KCM",
    price: 1.15,
    image: "./public/images/maluma.jpg",
    attributes: {
      description:
  ...
  "6trfgkkj": {
    ...
    sku: "AX4M8SJV",
    price: 1.21,
    image: "./public/images/fuerte.jpg",
    attributes: {
      description:
  ...
  fpr72m9k: {
    ...
    sku: "B4HZ42TM",
    price: 1.27,
    image: "./public/images/pinkerton.jpg",
    attributes: {
      description:
  ...
  t345w48y: {
    ...
    sku: "MW79ZZ6Y",
    price: 1.25,
    image: "./public/images/zutano.jpg",
    attributes: {
      description:
